...
%À l'inévitable question fréquente : "Il fait quoi votre robot", nous répondons "rien".
%Paragraphe expliquant l'USAGE : programmable en n'importe quel langage, évolutif, exemple d'application (ie: navigation vision, voiture autonome).
%Le robot n'est pas préprogrammé, mais dispose de toute la documentation nécessaire
