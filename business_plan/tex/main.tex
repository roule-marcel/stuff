...
%Par exemple, dans les universités des pays germaniques et anglo-saxons notamment, on appelle \emph{laboratory} les séances de \textbf{Travaux Pratiques (TP)}.
...
%L'usage de robots de laboratoire peut être très varié, allant de la recherche en intelligence artificielle, 
...
%documentation, difficulté modification/réparation, service après-vente (plate-forme agée, continuité, le gars qui a commandé est plus là).
